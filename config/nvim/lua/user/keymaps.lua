...
local keymaps = {
	...
	n = {
		...
		{ "<leader>t", "<cmd>lua require('user.utils').format_current_file()<CR>" },
		{ "<leader>lg", "<cmd>LazyGit<CR>" },
		{ "<leader>ng", "<cmd>Neogen<CR>" },
		{ "<leader>al", ":!alacritty& <CR>" },
		{ "<leader>cl", ":!alacritty -e sh -c 'cd %:p:h && claude'& <CR>" },
		...
		{ "<leader>5", "%" },
		{ "ge", "G" },
		{ "<leader>cb", "<cmd>lua require('user.utils').insert_comment_box()<CR>" },
	},
	i = {
